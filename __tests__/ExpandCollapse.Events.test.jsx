...
describe("<ExpandCollapse />", function() {
  it("handles expand click button", function() {
    ...
    expect(wrapper.find('.react-expand-collapse__button').text()).toEqual("... Expand");
    wrapper.find(".react-expand-collapse__button").simulate("click");
    expect(wrapper.find('.react-expand-collapse__button').text()).toEqual("Collapse");
  });
});
